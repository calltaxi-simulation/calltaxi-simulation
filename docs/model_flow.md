...
절대 크기만 신뢰할 수 없다. 244곳 × 시드 3회 결과는
[evaluation.md](evaluation.md) 「실행 결과」 절.
...
(08.12 보강 — 총 대기도 참고 열로 함께 낸다.
[evaluation.md](evaluation.md) 「총 대기도 함께 재되 참고 열이다」 절.)
...
건드리지 않고 갈아끼우려는 것이다([evaluation.md](evaluation.md) 「민감도」 절).
